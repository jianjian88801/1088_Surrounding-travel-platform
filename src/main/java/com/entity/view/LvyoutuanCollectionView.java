...
public class LvyoutuanCollectionView extends LvyoutuanCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String lvyoutuanCollectionValue;
	...
	public LvyoutuanCollectionView() {

	}

	public LvyoutuanCollectionView(LvyoutuanCollectionEntity lvyoutuanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, lvyoutuanCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getLvyoutuanCollectionValue() {
				return lvyoutuanCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setLvyoutuanCollectionValue(String lvyoutuanCollectionValue) {
				this.lvyoutuanCollectionValue = lvyoutuanCollectionValue;
			}
