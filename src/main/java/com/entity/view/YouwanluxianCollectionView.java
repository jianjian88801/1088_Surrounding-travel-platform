...
public class YouwanluxianCollectionView extends YouwanluxianCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String youwanluxianCollectionValue;
	...
	public YouwanluxianCollectionView() {

	}

	public YouwanluxianCollectionView(YouwanluxianCollectionEntity youwanluxianCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, youwanluxianCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getYouwanluxianCollectionValue() {
				return youwanluxianCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setYouwanluxianCollectionValue(String youwanluxianCollectionValue) {
				this.youwanluxianCollectionValue = youwanluxianCollectionValue;
			}
