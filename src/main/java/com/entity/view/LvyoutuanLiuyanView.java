...
public class LvyoutuanLiuyanView extends LvyoutuanLiuyanEntity implements Serializable {
	...
	public LvyoutuanLiuyanView() {

	}

	public LvyoutuanLiuyanView(LvyoutuanLiuyanEntity lvyoutuanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, lvyoutuanLiuyanEntity);
