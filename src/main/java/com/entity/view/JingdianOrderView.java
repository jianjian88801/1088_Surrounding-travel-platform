...
public class JingdianOrderView extends JingdianOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 订单类型的值
		*/
		private String jingdianOrderValue;
		/**
		* 支付类型的值
		*/
		private String jingdianOrderPaymentValue;
	...
	public JingdianOrderView(JingdianOrderEntity jingdianOrderEntity) {
		try {
			...
			* 获取： 订单类型的值
			*/
			public String getJingdianOrderValue() {
				return jingdianOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setJingdianOrderValue(String jingdianOrderValue) {
				this.jingdianOrderValue = jingdianOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getJingdianOrderPaymentValue() {
				return jingdianOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setJingdianOrderPaymentValue(String jingdianOrderPaymentValue) {
				this.jingdianOrderPaymentValue = jingdianOrderPaymentValue;
			}
