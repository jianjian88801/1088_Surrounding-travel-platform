 ...
 */
@TableName("lvyoutuan")
public class LvyoutuanView extends LvyoutuanEntity implements Serializable {
	...
	public LvyoutuanView() {

	}

	public LvyoutuanView(LvyoutuanEntity lvyoutuanEntity) {
		try {
			BeanUtils.copyProperties(this, lvyoutuanEntity);
