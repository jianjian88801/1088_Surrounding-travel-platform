...
public class FangjianCommentbackView extends FangjianCommentbackEntity implements Serializable {
	...
	public FangjianCommentbackView() {

	}

	public FangjianCommentbackView(FangjianCommentbackEntity fangjianCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, fangjianCommentbackEntity);
