...
public class JingdianCommentbackView extends JingdianCommentbackEntity implements Serializable {
	...
	public JingdianCommentbackView() {

	}

	public JingdianCommentbackView(JingdianCommentbackEntity jingdianCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, jingdianCommentbackEntity);
