...
var centerMenu = [
    ...
    ,{
        name: '房间收藏',
        url: '../fangjianCollection/list.html'
    }
    ,{
        name: '房间订单',
        url: '../fangjianOrder/list.html'
    }
    ,{
        name: '景点收藏',
    ...
    ,{
        name: '旅游团收藏',
        url: '../lvyoutuanCollection/list.html'
    }
    ,{
        name: '旅游团拼团',
        url: '../lvyoutuanOrder/list.html'
    }
    ,{
        name: '游玩路线收藏',
        url: '../youwanluxianCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '旅游团',
        url: './pages/lvyoutuan/list.html'
    },
    {
        name: '游玩路线',
        url: './pages/youwanluxian/list.html'
    },
    {
        name: '公告',
...
var adminurl =  "http://localhost:8080/zhoubianyoupingtai/admin/dist/index.html#/login";
